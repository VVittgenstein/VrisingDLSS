...
4. After Phase 1, resume the technical path from `docs/development/pause-state-2026-06-05.md`:
...
As of this reconstruction:

- Branch: `main`.
- Latest pre-reconstruction commit: `57689f2 Document DLSS MVP pause state`.
