...
$summary = [pscustomobject]@{
    ...
    NextRecommendation = if ($mvpReady) {
        ...
        "Pass -GamePath to include local runtime evidence. Current MVP next step is not another broad DLSS search or unchanged RenderGraph map run: the native-renderfunc-entry preflight plus menu/gameplay proofs passed, native-renderfunc-args menu/gameplay proofs passed, native-renderfunc-resource-identity menu/gameplay proofs passed, and native-renderfunc-resource-tuple menu/gameplay proofs passed. The default-off native-renderfunc-resource-resolve preflight is implemented; run its 1920x1080 Windowed menu proof first, still without GetTexture, native texture pointer reads, command-buffer access, or DLSS evaluate."
        ...
        "Do not rerun rejected RenderGraph wrapper stages unchanged. The official HDRP DLSS boundary is the Deep Learning Super Sampling render func, but V Rising has no proven safe Harmony-equivalent boundary. The rendergraph-compiled-pass-info proof plus native-renderfunc-entry preflight/menu/gameplay proofs passed, native-renderfunc-args menu/gameplay proofs passed, native-renderfunc-resource-identity menu/gameplay proofs passed, and native-renderfunc-resource-tuple menu/gameplay proofs passed. The default-off native-renderfunc-resource-resolve preflight is implemented; next narrow step is its 1920x1080 Windowed menu proof, still without GetTexture, native texture pointer reads, command-buffer access, or DLSS evaluate."
