...
$summary = [pscustomobject]@{
    ...
    NextRecommendation = if ($mvpReady) {
        ...
        "Pass -GamePath to include local runtime evidence. Current MVP next step is not another broad DLSS search or unchanged RenderGraph map run: the native-renderfunc-entry preflight plus menu/gameplay proofs passed, native-renderfunc-args menu/gameplay proofs passed, native-renderfunc-resource-identity menu/gameplay proofs passed, native-renderfunc-resource-tuple menu/gameplay proofs passed, native-renderfunc-resource-resolve menu/gameplay proofs passed, and native-renderfunc-resource-native-pointer menu/gameplay proofs passed. Next narrow step is the default-off no-native hdrp-postprocess-boundary proof over RenderPostProcess/DoDLSSPass/CustomPostProcessPass and concrete ProjectM custom postprocess Render methods; do not combine command-buffer access, D3D11 validation, or DLSS evaluate with this boundary proof."
        ...
        "Do not rerun rejected RenderGraph wrapper stages unchanged. The official HDRP DLSS boundary is the Deep Learning Super Sampling render func, but V Rising has no proven safe Harmony-equivalent boundary. The rendergraph-compiled-pass-info proof plus native-renderfunc-entry preflight/menu/gameplay proofs passed, native-renderfunc-args menu/gameplay proofs passed, native-renderfunc-resource-identity menu/gameplay proofs passed, native-renderfunc-resource-tuple menu/gameplay proofs passed, native-renderfunc-resource-resolve menu/gameplay proofs passed, and native-renderfunc-resource-native-pointer menu/gameplay proofs passed. Next narrow step is the default-off no-native hdrp-postprocess-boundary proof over RenderPostProcess/DoDLSSPass/CustomPostProcessPass and concrete ProjectM custom postprocess Render methods; do not combine command-buffer access, D3D11 validation, or DLSS evaluate with this boundary proof."
