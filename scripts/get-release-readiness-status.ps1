...
$summary = [pscustomobject]@{
    ...
    NextRecommendation = if ($mvpReady) {
        ...
        "Pass -GamePath to include local runtime evidence. Current MVP next step is not another broad DLSS search or unchanged RenderGraph map run: the native-renderfunc-entry preflight plus menu/gameplay proofs passed, native-renderfunc-args menu/gameplay proofs passed, native-renderfunc-resource-identity menu/gameplay proofs passed, and native-renderfunc-resource-tuple menu/gameplay proofs passed. Design the first separately guarded resource-resolution preflight using the proven native render-func tuple metadata as locator, default-off and menu-first, still without command-buffer access or DLSS evaluate."
        ...
        "Do not rerun rejected RenderGraph wrapper stages unchanged. The official HDRP DLSS boundary is the Deep Learning Super Sampling render func, but V Rising has no proven safe Harmony-equivalent boundary. The rendergraph-compiled-pass-info proof plus native-renderfunc-entry preflight/menu/gameplay proofs passed, native-renderfunc-args menu/gameplay proofs passed, native-renderfunc-resource-identity menu/gameplay proofs passed, and native-renderfunc-resource-tuple menu/gameplay proofs passed. Next narrow step is a separately guarded resource-resolution preflight using the proven native render-func tuple metadata as locator, default-off and menu-first, still without command-buffer access or DLSS evaluate."
