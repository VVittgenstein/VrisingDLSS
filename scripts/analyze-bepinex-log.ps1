...
$results.Add((New-StageResult `
    ...
    -FailPatterns @("DLSS evaluate input probe failed:", "DLSS evaluate input probe failed from existing HDRP render-func:", "DLSS evaluate input probe failed from RenderGraph materialization:", "DLSS evaluate input probe failed from DLSSPass resource helper:") `
